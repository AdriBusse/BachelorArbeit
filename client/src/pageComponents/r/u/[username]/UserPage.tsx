                    ...
                    <div className="w-160">
                        {data.getUser.userSubmissions.map((submission: any) => {
                            if (submission.__typename === 'Post') {
                                ...
                                return <PostCard subId={"1"} key={post.identifier} post={post} />;
                            } else {
                                    ...
                                    >
                                        ...
                                        <div className="w-full p-2">
                                            <p className="mb-2 text-xs text-gray-500">
                                                ...
                                                <Link prefetch={false} href={comment.post.url}>
                                                    <a
                                                        href=""
                                                ...
                                                <Link prefetch={false} href={`/r/${comment.post.subName}`}>
                                                    <a
                                                        href=""
                        ...
                        <div className="bg-white rounded ">
                            ...
                            <div className="p-2 text-center">
                                ...
                                {user?.username === username &&
                                    ...
                                    <Link prefetch={false} href={`/u/${username}/subs`}>
