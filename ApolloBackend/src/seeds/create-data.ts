...
export default class CreateData implements Seeder {
  public async run(_: any, connection: Connection): Promise<any> {
    ...
    const adri = await User.findOne({ username: 'adri' });
      ...
      .values([
        {
          ...
          describtion: 'A group of React JS fanboys',
          user: adri,
        ...
        },
        {
          ...
          describtion: 'If you cant joke your life is a joke',
          user: jane,
        ...
        },
        {
          ...
          describtion: "Questions that make you go 'Ohhh'",
          user: adri,
        ...
        },
        {
          ...
          describtion: 'Your nexus for all things Ready Player One',
          user: jane,
          createdAt: timePlus(hour),
          updatedAt: timePlus(hour),
        },
    ...
    await connection
      ...
      .into(Vote)
      .values([
        { value: 1, user: adri, post: post9 },
        { value: 1, user: jane, post: post9 },
        { value: 1, user: jane, post: post8 },
        { value: 1, user: adri, comment: comment1 },
        { value: 1, user: jane, comment: comment1 },
        { value: 1, user: adri, comment: comment2 },
      ])
      .execute();
  }
}
